...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"resp-versions","title":"RESP versions"},{"id":"network-layer","title":"Network layer"},{"id":"request-response-model","title":"Request-Response model"},{"children":[{"id":"simple-strings","title":"Simple strings"},{"id":"simple-errors","title":"Simple errors"},{"id":"integers","title":"Integers"},{"id":"bulk-strings","title":"Bulk strings"},{"id":"null-bulk-strings","title":"Null bulk strings"},{"id":"arrays","title":"Arrays"},{"id":"nulls","title":"Nulls"},{"id":"booleans","title":"Booleans"},{"id":"doubles","title":"Doubles"},{"id":"big-numbers","title":"Big numbers"},{"id":"bulk-errors","title":"Bulk errors"},{"id":"verbatim-strings","title":"Verbatim strings"},{"id":"maps","title":"Maps"},{"id":"attributes","title":"Attributes"},{"id":"sets","title":"Sets"},{"id":"pushes","title":"Pushes"}],"id":"resp-protocol-description","title":"RESP protocol description"},{"id":"client-handshake","title":"Client handshake"},{"id":"sending-commands-to-a-redis-server","title":"Sending commands to a Redis server"},{"id":"multiple-commands-and-pipelining","title":"Multiple commands and pipelining"},{"id":"inline-commands","title":"Inline commands"},{"id":"high-performance-parser-for-the-redis-protocol","title":"High-performance parser for the Redis protocol"},{"id":"tips-for-redis-client-authors","title":"Tips for Redis client authors"}]}
...
## Client handshake
New RESP connections should begin the session by calling the [`HELLO`](https://redis.io/docs/latest/commands/hello) command.
...
* For testing purposes, use [Lua's type conversions](https://redis.io/docs/latest/develop/programmability/lua-api#lua-to-resp3-type-conversion) to have Redis reply with any RESP2/RESP3 needed.
